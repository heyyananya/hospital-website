...
const TRANSLATIONS = {
  en: {
    ...
    "test-1-text": "\"Superspeciality Doctors Consultation saved me hours of clinic waiting. I booked cardiology from home, paid on Razorpay, and monitored my live token queue status instantly!\"",
    "test-1-name": "Kirtan Mehta",
    "test-1-city": "Palanpur, Gujarat",
    "test-2-text": "\"The disease mapping search is very clever. I searched 'cough' and it showed Pulmonology doctors. The Gujrati translation is fully accurate!\"",
    "test-2-name": "Ramilaben Patel",
    "test-2-city": "Deesa Highway, Palanpur",
    "test-3-text": "\"I can log in as a Doctor and immediately edit my availability badge to 'Running Late'. Patients see changes instantly. Highly recommended SaaS workflow.\"",
    "test-3-name": "Dr. Rajesh Shah",
    "test-3-city": "Senior Pulmonologist",
  ...
  gu: {
    ...
    "test-1-text": "\"સુપરસ્પેશિયાલિટી ડોકટર્સ કન્સલ્ટેશનથી મારો કલાકોનો સમય બચ્યો છે. મેં ઘરેથી જ કાર્ડિયોલોજી બુક કર્યું, Razorpay પર ફી ચૂકવી અને લાઈવ ટોકન સ્ટેટસ મેળવ્યું!\"",
    "test-1-name": "કિર્તન મહેતા",
    "test-1-city": "પાલનપુર, ગુજરાત",
    "test-2-text": "\"રોગ મેપિંગ શોધ ખૂબ જ સ્માર્ટ છે. મેં 'ઉધરસ' સર્ચ કર્યું અને પલ્મોનોલોજી ડોકટરો બતાવ્યા. ગુજરાતી અનુવાદ ૧૦૦% સાચો છે!\"",
    "test-2-name": "રમીલાબેન પટેલ",
    "test-2-city": "ડીસા હાઇવે, પાલનપુર",
    "test-3-text": "\"હું ડૉક્ટર તરીકે લોગ ઇન કરી શકું છું અને મારી ઉપલબ્ધતાના બેજને તરત જ 'મોડું ચાલે છે' માં બદલી શકું છું. દર્દીઓ ફેરફારો તરત જ જોઈ શકે છે. ખૂબ જ ઉપયોગી સુવિધા.\"",
    "test-3-name": "ડો. રાજેશ શાહ",
    "test-3-city": "સીનિયર પલ્મોનોલોજીસ્ટ",
  ...
  hi: {
    ...
    "test-1-text": "\"सुपरस्पेशलिटी डॉक्टर्स कंसल्टेशन ने क्लिनिक में घंटों प्रतीक्षा करने से मेरा समय बचा लिया। मैंने घर से कार्डियोलॉजी अपॉइंटमेंट बुक किया, रेज़रपे पर भुगतान किया, और तुरंत लाइव कतार टोकन देखा!\"",
    "test-1-name": "कीर्तन मेहता",
    "test-1-city": "पालनपुर, गुजरात",
    "test-2-text": "\"बीमारी खोज पट्टी बहुत समझदार है। मैंने 'खांसी' खोजा और इसने पल्मोनोलॉजी डॉक्टरों को दिखाया। अनुवाद पूरी तरह से सटीक है!\"",
    "test-2-name": "रमीलाबेन पटेल",
    "test-2-city": "डीसा हाईवे, पालनपुर",
    "test-3-text": "\"मैं डॉक्टर के रूप में लॉग इन कर सकता हूं और तुरंत अपनी उपलब्धता बैज को 'देरी से चल रहा है' में बदल सकता हूं। मरीज तुरंत बदलाव देख सकते हैं। बेहद अनुशंसित SaaS वर्कफ़्लो।\"",
    "test-3-name": "डॉ. राजेश शाह",
    "test-3-city": "वरिष्ठ पल्मोनोलॉजिस्ट",
